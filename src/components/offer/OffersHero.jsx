    ...
    return (
        <section className="relative isolate min-h-90 overflow-hidden bg-[#efe6dc] sm:min-h-[540px]">
            ...
            <picture className="absolute inset-0 -z-20">
                <source media="(max-width: 639px)" srcSet="/hero/hero4-mobile.png" />
                <img
                    src="/hero/hero4.png"
                    alt="Exclusive offers from Zeccora"
                    className="block h-full w-full object-contain sm:object-fill"
                />
            </picture>
            ...
            <div className="mx-auto flex min-h-[360px] max-w-7xl items-end px-4 py-8 sm:min-h-[540px] sm:items-center sm:px-8 sm:py-10 lg:px-12">
                ...
                <div className="relative max-w-xl overflow-hidden rounded-[24px] border border-white/70 bg-white/80 p-4 shadow-[0_30px_80px_rgba(26,18,12,0.2)] backdrop-blur-xl sm:rounded-[32px] sm:p-9 lg:p-10">
                    ...
                    <p className="mt-5 max-w-md text-sm leading-7 text-[#5c4c40]">
                        30% OFF on the Zeccora Collection - available now.
                        15% OFF coming soon! Sale prices are applied to
                        products and in your cart.
                    </p>
                    ...
                    <div className="chip-row mt-5 sm:mt-7 sm:flex-wrap">
                        {OFFERS.map((offer) => (
                            <Link
                                key={offer.percent}
                                to={offer.href}
                                className={`inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-[11px] font-semibold uppercase tracking-[0.14em] transition ${offer.comingSoon
