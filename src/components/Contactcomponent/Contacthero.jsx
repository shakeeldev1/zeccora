...
const Contacthero = () => {
    return (
        <section className="relative isolate overflow-hidden border-b border-[#9F6324]/20 bg-gradient-to-b from-[#000000] via-[#120805] to-[#000000]">
            <img
            ...
            <div className="mx-auto flex min-h-[420px] max-w-[1600px] items-center justify-center px-4 py-16 sm:min-h-[500px] sm:px-6 lg:px-10">
                <div className="flex max-w-5xl flex-col items-center text-center">
                    <div className="mb-7 flex items-center justify-center gap-3 text-lg font-medium text-[#9F6324] sm:text-2xl">
                        <span className="text-white/90">Home</span>
                        <span className="text-[#9F6324]">&gt;</span>
                        <span>Contact</span>
                    </div>

                    <button
                        type="button"
                        className="mb-8 inline-flex items-center gap-2 rounded-full border border-[#9F6324]/60 bg-[#9F6324]/15 px-6 py-3 text-sm font-semibold tracking-[0.12em] text-[#FFFFC9] shadow-[0_0_25px_rgba(159,99,36,0.15)] backdrop-blur-sm transition hover:bg-[#9F6324]/20"
                    >
                        <span className="flex h-4 w-4 items-center justify-center rounded-full border border-[#9F6324] text-[5px]">
                            <Sparkles size={10} />
                        </span>
                        CONNECT WITH US
                    </button>

                    <h1 className=" text-5xl font-bold tracking-[-0.04em] text-white sm:text-6xl lg:text-[7.5rem] lg:leading-[0.9]">
                        Connect <span className="text-[#9F6324]">With Us</span>
                    </h1>
