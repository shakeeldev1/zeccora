                  ...
                  >
                    ...
                    <div className="mt-6 flex gap-2.5 sm:mt-8 sm:gap-3">
                      ...
                      <Link
                        ...
                        className="inline-flex flex-1 items-center justify-center rounded-full bg-white px-4 py-3.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-[#1a120c] transition hover:bg-[#E8C27A] sm:flex-none sm:px-7 sm:text-[11px] sm:tracking-[0.2em]"
                      >
                        50% Off
                      </Link>
                    </div>
